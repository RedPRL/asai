...
let () =
  exec (Terminal.display ~debug:true ~use_ansi:true ~use_color:true);
  exec (Terminal.display ~debug:true ~use_ansi:true ~use_color:false);
  exec (Terminal.display ~debug:true ~use_ansi:false ~use_color:false);
