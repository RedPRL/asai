...
module Make (Message : MinimumSigs.Message) : sig
  ...
  *)
  val display : ?debug:bool -> ?output:out_channel -> ?use_ansi:bool -> ?use_color:bool -> ?show_backtrace:bool -> ?line_breaks:[`Unicode | `Traditional] -> ?block_splitting_threshold:int -> ?tab_size:int -> Message.t Diagnostic.t -> unit
end
